...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
      ...
      if (isExternal)
        return (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-mid hover:text-accent-teal underline underline-offset-2">
            {children}
          </a>
        )
      return (
    ...
    h2: (props) => {
      ...
      return (
        <Link id={id} className="blog-heading !heading-sm !no-underline" href={href} data-heading={heading}>
