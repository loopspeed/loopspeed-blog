...
const DrawingShaderMaterialExtended = extend(DrawingShaderMaterial)
...
const ResetDrawingShaderMaterialExtended = extend(ResetDrawingShaderMaterial)
...
const Drawing: FC<DrawingProps> = ({ version }) => {
  const shader = useRef<typeof DrawingShaderMaterialExtended & Partial<Uniforms>>(null)
  const resetShader = useRef<typeof ResetDrawingShaderMaterialExtended & Partial<ResetUniforms>>(null)
  ...
  return (
    <ScreenQuad>
      <ResetDrawingShaderMaterialExtended ref={resetShader} uColour={new Color('#000')} />
      <DrawingShaderMaterialExtended
        ref={shader}
        transparent={true}
