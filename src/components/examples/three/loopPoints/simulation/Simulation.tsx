...
import { createPortal, extend, useThree, Viewport } from '@react-three/fiber'
...
const LoopPointsSimulationShaderMaterialExtended = extend(LoopPointsSimulationShaderMaterial)
...
type Ref = typeof LoopPointsSimulationShaderMaterialExtended & SimulationUniforms

const LoopParticleSimulationMaterial = forwardRef<Ref, Props>(({ mesh, particlesCount, fboScene }, ref) => {
    ...
    <>
      {createPortal(
        <ScreenQuad>
          ...
          <LoopPointsSimulationShaderMaterialExtended
