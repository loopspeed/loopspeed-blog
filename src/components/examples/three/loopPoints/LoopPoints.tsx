...
const LoopPointsShader = extend(LoopPointsShaderMaterial)
...
const LoopPoints = forwardRef<Points, Props>(({ isScattered, mesh }, ref) => {
  ...
  const pointsShaderMaterial = useRef<typeof LoopPointsShader & Partial<PointsShaderUniforms>>(null)
