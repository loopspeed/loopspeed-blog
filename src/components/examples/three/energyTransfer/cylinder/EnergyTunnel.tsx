...
const ShaderMaterial = extend(EnergyCylinderShaderMaterial)

const EnergyTunnel: FC = ({}) => {
  const shaderMaterial = useRef<typeof ShaderMaterial & Partial<Uniforms>>(null)
  ...
  useGSAP(
    () => {
      ...
      for (let i = 0; i < NUMBER_OF_LINES; i++) {
        lineParams.current.set(generateRandomLineParams(), i * 3)
