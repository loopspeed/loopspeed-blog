...
const EnergyPointsShaderMaterialExtended = extend(EnergyPointsShaderMaterial)

const NUMBER_OF_POINTS = 96

const EnergyTunnelPoints: FC = () => {
  const shaderMaterial = useRef<typeof EnergyPointsShaderMaterialExtended & Uniforms>(null)
    ...
    <points dispose={null}>
      <bufferGeometry attach="geometry">
        ...
        <bufferAttribute
          ...
          array={sparkleSeeds}
          count={sparkleSeeds.length}
          itemSize={1}
        />
      </bufferGeometry>
      <EnergyPointsShaderMaterialExtended
        ref={shaderMaterial}
