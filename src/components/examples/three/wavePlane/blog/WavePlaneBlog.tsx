...
const WavePlaneBasicShaderMaterialExtended = extend(WavePlaneBasicShaderMaterial)
const WavePlaneGradientShaderMaterialExtended = extend(WavePlaneGradientShaderMaterial)
const WavePlaneGridShaderMaterialExtended = extend(WavePlaneGridShaderMaterial)
...
const BasicFragmentShaderPlane: FC = () => {
  ...
  const shaderMaterial = useRef<typeof WavePlaneBasicShaderMaterialExtended & Uniforms>(null)
  ...
  return (
    <mesh position={[0, -viewport.height / 2.5, -1]} rotation={[-0.5 * Math.PI, 0, 0]}>
      <planeGeometry args={[planeSize, planeSize, planeSegments, planeSegments]} />
      <WavePlaneBasicShaderMaterialExtended
        ref={shaderMaterial}
...
const GradientFragmentShaderPlane: FC = () => {
  ...
  const shaderMaterial = useRef<typeof WavePlaneGradientShaderMaterialExtended & Uniforms>(null)
  ...
  return (
    <mesh position={[0, -viewport.height / 2.5, -1]} rotation={[-0.5 * Math.PI, 0, 0]}>
      <planeGeometry args={[planeSize, planeSize, planeSegments, planeSegments]} />
      <WavePlaneGradientShaderMaterialExtended
        ref={shaderMaterial}
...
const GridLinesFragmentShaderPlane: FC = () => {
  ...
  const shaderMaterial = useRef<typeof WavePlaneGridShaderMaterialExtended & Uniforms>(null)
  ...
  return (
    <mesh position={[0, -viewport.height / 2.5, -1]} rotation={[-0.5 * Math.PI, 0, 0]}>
      <planeGeometry args={[planeSize, planeSize, planeSegments, planeSegments]} />
      <WavePlaneGridShaderMaterialExtended
        ref={shaderMaterial}
