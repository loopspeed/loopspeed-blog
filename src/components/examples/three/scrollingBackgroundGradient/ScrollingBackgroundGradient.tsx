...
const ScrollingBackgroundMaterialExtended = extend(ScrollingBackgroundMaterial)
...
const ScrollingBackgroundGradient: FC<Props & Config> = ({
  ...
  const gradientShader = useRef<typeof ScrollingBackgroundMaterialExtended & Uniforms>(null)
  ...
  return (
    <ScreenQuad>
      <ScrollingBackgroundMaterialExtended
