...
const ImageSequenceHeader: FC = () => {
  ...
  return (
    <>
      <header ref={header} className="relative h-[200lvh] w-full overflow-hidden select-none">
        <div id="content-wrapper" className="relative z-20 flex h-lvh w-full items-center justify-center">
          <div id="heading" className="flex w-fit flex-col gap-6 opacity-0">
            <h1 className="text-3xl leading-none font-extrabold tracking-tighter whitespace-nowrap text-white md:text-[8.5vmax]">
              Animate Responsibly
            </h1>
          ...
          <h2 className="absolute scale-75 text-center text-2xl leading-none font-bold tracking-tighter text-white opacity-0 md:text-[6vmax]">
            Be principled
          </h2>
