...
const RayMarchingShaderMaterialExtended = extend(RayMarchingShaderMaterial)

const RayMarchingScreenQuadShader: FC = () => {
  const { viewport } = useThree()
  const shader = useRef<typeof RayMarchingShaderMaterialExtended & Uniforms>(null)
  ...
  return (
    <ScreenQuad>
      <RayMarchingShaderMaterialExtended
