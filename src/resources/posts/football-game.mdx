...
<Aside title="Tech Stack">
  - **Next.js** _as the web framework_ - **React Three Fiber** _for 3D rendering_ - **Rapier** _for physics simulation
  and collision sensors_ - **@use-gesture** _for the drag/flick input_ - **GSAP** _for camera animation and shake_ -
  **Zustand** _for state management_ - **Tailwind** _for the 2D HUD and UI_
</Aside>
