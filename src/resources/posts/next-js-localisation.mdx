...
export const metadata = {
  title: 'How to use Google Sheets as a free CMS for Next.js Localisation - supporting unlimited locales',
  description:
  ...
  tags: [TagName.Tutorial, TagName.NextJS, TagName.Typescript, 'localisation', 'translations', 'google-sheets', 'html-react-parser'],
...
### Why Google Sheets as a mini CMS?
...
- **Structured yet flexible** — formulas help enforce conventions (e.g. generate kebab-case keys from “key-as-text”).  
