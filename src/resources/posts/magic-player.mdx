...
- **Three.js Shading Language** (TSL) for node-based shading — no GLSL files required!
...
In order to syncronise the mesh position with the ripple impact, an additional 'bounce phase' value is stored in the player position vector.
