...
export const metadata = {
  ...
  date: '2025-01-12',
  slug: BlogSlug.NextJsWebGLShaderSetup,
  tags: [TagName.Tutorial, TagName.NextJS, TagName.ThreeJS, TagName.Typescript, TagName.WebGL, 'glslify', 'custom shader material'],
  authors: [MATTHEW_FRAWLEY],
  youtubeUrl: 'https://youtu.be/_YvCZ4I16Vg',
  githubUrl: 'https://github.com/prag-matt-ic/pragmattic/blob/main/src/components/examples/scrollingBackgroundGradient/ScrollingBackgroundGradient.tsx',
}
